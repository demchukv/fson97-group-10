import{i as E,a as b,P as U}from"./vendor-e8675f53.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();function f(e,t="info"){t==="OK"?E.success({position:"topCenter",message:e}):t==="ERROR"?E.error({position:"topCenter",message:e}):E.info({position:"topCenter",message:e})}function l(e="show"){const t=document.querySelector(".loader");e==="show"?t.style.display="inline-block":t.style.display="none"}const i={gallery:document.querySelector(".gallery"),buttons:document.querySelector(".exercises-btns-div"),pagination:document.getElementById("pagination"),musclesBtn:document.querySelector('[data-filter="muscles"]'),bodypartsBtn:document.querySelector('[data-filter="bodypart"]'),equipBtn:document.querySelector('[data-filter="equipment"]')};b.defaults.baseURL="https://energyflow.b.goit.study/api";const u={perPage:12,page:1,filter:"Muscles",totalPages:1,totalItems:0};async function w(){return l(),(await b.get("/filters",{params:{filter:u.filter,page:u.page,limit:u.perPage}})).data}function k(e){i.gallery.innerHTML="";const t=e.map(({name:s,filter:r,imgUrl:a})=>`<li class="gallery-item">
    ...
    </li>`).join("");i.gallery.innerHTML=t,l("hide")}function B(){u.page=1,w().then(e=>{const{results:t,totalPages:s,page:r}=e;if(k(t),s>1){const a=D(r,s);i.pagination.innerHTML=a}else i.pagination.innerHTML=""}).catch(e=>{l("hide"),f(e.message,"ERROR")})}B();i.musclesBtn.classList.add("active");i.musclesBtn.disabled=!0;i.buttons.addEventListener("click",e=>{A(e);const t=e.target;t!==e.currentTarget&&(t===i.musclesBtn?(i.musclesBtn.disabled=!0,i.bodypartsBtn.disabled=!1,i.equipBtn.disabled=!1,u.filter="Muscles"):t===i.bodypartsBtn?(i.musclesBtn.disabled=!1,i.bodypartsBtn.disabled=!0,i.equipBtn.disabled=!1,u.filter="Body parts"):t===i.equipBtn&&(i.musclesBtn.disabled=!1,i.bodypartsBtn.disabled=!1,i.equipBtn.disabled=!0,u.filter="Equipment"),B())});let m=null;function A(e){const t=e.target.nodeName==="BUTTON";i.musclesBtn.classList.remove("active"),t&&(e.target.classList.add("active"),m!==null&&m.classList.remove("active"),m=e.target,m===m&&m.classList.add("active"))}i.pagination.addEventListener("click",G);function D(e,t){let s="";for(;e<=t;e++)s+=`<button class="pagination-btn" type="button">${e}</button>`;return s}async function G(e){u.page=e.target.textContent,i.gallery.innerHTML="";try{const{results:t}=await w();k(t)}catch(t){console.log(t)}}const g="/fson97-group-10/assets/icons-7beb2351.svg",n={page:1,totalPages:1,totalItems:0,keyword:"",filter:"",filterGroup:"",limit:12},p=document.querySelector(".gallery");p&&(p.addEventListener("click",j),p.classList.add("exercises-card"));const $=document.querySelector(".search-btn"),y=document.querySelector(".search-clear-btn"),d=document.querySelector(".search-input"),q=document.querySelector(".exercises-btns-div"),S=document.querySelector(".ex-search");function j(e){if(e.preventDefault(),e.target.closest("ul").dataset.exercises){$.addEventListener("click",T),y.addEventListener("click",C),d.addEventListener("input",P),q.addEventListener("click",M),S.classList.remove("visually-hidden");const t=document.querySelector(".exercises-button.active");n.filter=t.dataset.filter,n.filterGroup=e.target.closest("ul").dataset.exercises,L(n.filter)}}function T(e){e.preventDefault(),d.value.length>3&&(n.page=1,n.keyword=d.value.trim().toLowerCase(),L(n.filter,!0))}function L(e,t=!0){p.innerHTML="",F(e).then(s=>{n.totalPages=s.totalPages,n.totalItems=n.limit*s.totalPages,s.results.length===0?p.innerHTML='<p class="ex-list-no-result">Unfortunately, <span class="accent-text">no results</span> were found. You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p>':(K(s.results),t&&_()),l("hide")}).catch(s=>{l("hide"),f(s.message,"ERROR")})}async function F(e){return l(),d.value.length>3?n.keyword=d.value.trim().toLowerCase():n.keyword="",(await b.get("/exercises",{params:{[e]:n.filterGroup,keyword:n.keyword,page:n.page,limit:n.limit}})).data}function K(e){let t=e.map(s=>`<li class="exercise-item" data-id="${s._id}">
      ...
      <a class="ex-item-start" href="#" data-id="${s._id}"><span>Start</span> <svg class="ex-arrow-icon" width="14" height="14"><use href="${g}#icon-arrow-start"></use></svg></a>
      </p>
      <span class="ex-title">
...
//# sourceMappingURL=main-99ef887c.js.map
