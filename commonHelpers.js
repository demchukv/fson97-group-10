import{i as o}from"./assets/scroll-up-84ef2aa3.js";import"./assets/vendor-ecc6328a.js";const p={favoritesContent:document.querySelector(".favorites-card-content")},e="favorites";let t=null;try{let s=localStorage.getItem(e),a=JSON.parse(s);p.favoritesContent.innerHTML=`<ul class="favorites-group">${d(a)}</ul>`,t=document.querySelectorAll(".favorites-delete")}catch(s){console.log(s)}t&&t.forEach(s=>{s.addEventListener("click",a=>{let i=localStorage.getItem(e),n=JSON.parse(i);const r=a.target.closest(".favorites-item"),c=r.dataset.id;localStorage.setItem(e,JSON.stringify(n.filter(({_id:l})=>l!==c))),document.querySelector(".favorites-group").removeChild(r)})});function d(s){return s.map(a=>`
