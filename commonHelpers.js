import{i as s}from"./assets/scroll-up-5f43bc88.js";import"./assets/vendor-ecc6328a.js";const p={favoritesContent:document.querySelector(".favorites-card-content")},t="favorites";let r=null;try{let e=localStorage.getItem(t),a=JSON.parse(e);p.favoritesContent.innerHTML=`<ul class="favorites-group">${d(a)}</ul>`,r=document.querySelectorAll(".favorites-delete")}catch(e){console.log(e)}r&&r.forEach(e=>{e.addEventListener("click",a=>{let i=localStorage.getItem(t),n=JSON.parse(i);const o=a.target.closest(".favorites-item"),c=o.dataset.id;localStorage.setItem(t,JSON.stringify(n.filter(({_id:l})=>l!==c))),document.querySelector(".favorites-group").removeChild(o)})});function d(e){return e.map(a=>`
